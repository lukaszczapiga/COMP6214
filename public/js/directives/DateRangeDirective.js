var dateRangeDirective = angular.module('dateRangeDirective', []);

dateRangeDirective.directive('stDateRange', function () {
        return {
            restrict: 'E',
            require: '^stTable',
            scope: {
            ...
            templateUrl: 'js/directives/stDateRange.html',
    ...
    .directive('stNumberRange', ['$timeout', function ($timeout) {
        return {
            ...
            templateUrl: 'js/directives/stNumberRange.html',
            link: function (scope, element, attr, table) {
                var inputs = element.find('input');
